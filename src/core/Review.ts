...
export class Reviews {
  ...
  init(rootpath: string) {
    ...
    this.filepath = path.join(rootpath, '.vscode/i18n-ally-community-reviews.yml')
  ...
  private async save() {
    ...
    content = `# Review comments generated by i18n-ally-community. Please commit this file.\n\n${content}`
